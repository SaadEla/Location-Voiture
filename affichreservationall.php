                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <ul class="pull-right">
                                <li><a href="login_1.php" class="icon-1"><i class="fa fa-user"></i><span>Compte Administrateur</span></a></li>
								<li><a href="indexvisit.php" class="icon-1"><i class="fa fa-user"></i><span>Déconnexion</span></a></li>
                                        ...
                                        <div class="container1-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                                <ul class="nav navbar-nav">
                                                    <li >
                                                        <a href="accueiladmin.php"  role="button"  >Accueil</a>
                                                    ...
                                                    <li >
                                                        <a href="affichvehicule.php"  role="button">Véhicules
                                                      </a>
                                                      <!--  <ul class="dropdown-menu">
                                                    ...
                                                    <li >
                                                        <a href="affichfreservation.php"  role="button" >Réservations</a>
                                                      <!--  <ul class="dropdown-menu">
                                                    ...
                                                    <li >
                                                        <a href="affichclient.php"  role="button" >Clients</a>
                                                      <!--  <ul class="dropdown-menu">
													 ...
													 <li >
                                                        <a href="sell_a_car.php"  role="button" >Ajout</a>
                                                      <!--  <ul class="dropdown-menu">
                                                            <li><a href="about.html">About</a></li>
                                                            <li><a href="blog_1.html">Blog 1</a></li>
                                                            <li><a href="blog_2.html">Blog 2</a></li>
...
function affichreserv($bdd){
$req=$bdd->prepare('select * from réserver r,voiture v,client c WHERE v.idVehicule=r.idVehicule AND c.iduser=r.iduser ');
$req->execute();
return $req;
}
...
foreach ($var as $key){
	...
	echo "<tr><td>".$i."</td><td>".$key['NomClient']."</td><td>".$key['PrenomClient']."</td><td>".$d."</td><td>"
