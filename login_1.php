                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <ul class="pull-right">
                                <li><a href="login_1.php" class="icon-1"><i class="fa fa-user"></i><span>Mon Compte</span></a></li>
								  <li><a href="register.php" class="icon-1"><i class="fa fa-heart-o"></i><span>Créer Compte</span></a>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6 m-b-sm-30 m-b-xs-30">
									...
									<div class="p-lg-30 p-xs-15 bg-gray-f5 bg1-gray-15">
										<h3 class="p-t-lg-0">Créer Votre Compte</h3>
										<p>Saisir votre Email pour créer un comptre au niveau de notre application!</p>
										<form method="post" action="register.php">
											<div class="form-group">
												<input type="email" class="form-control form-item" placeholder="Email">
											</div>
											<button type="submit" class="ht-btn ht-btn-default">Inscription</button>
										</form>
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
									<!-- Login -->
									<div class="p-lg-30 p-xs-15 bg-gray-f5 bg1-gray-15">
										<h3 class="p-t-lg-0">Déjà Enregistré?</h3>
										<p>Saisir votre Email et Mot de passe pour s'authentifier!</p>
							            <form method="post" action="authentification.php">
											<div class="form-group">
												<input type="email" class="form-control form-item" name="email" placeholder="Email">
											</div>
											<div class="form-group">
												<input type="password" class="form-control form-item" name="password" placeholder="Mot de Passe">
											</div>
											<button type="submit" class="ht-btn ht-btn-default">Authentification</button>
										</form>
									</div>
								</div>
							</div>
