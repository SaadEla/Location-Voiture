                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <ul class="pull-right">
                                <li><a href="#" class="icon-1"><i class="fa fa-user"></i><span>Mon Compte</span></a></li>
                                <li><a href="#" class="icon-1"><i class="fa fa-heart-o"></i><span>Wishlist (0)</span></a>
                                </li>
                                        ...
                                        <div class="container1-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                                <ul class="nav navbar-nav">
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Accueil</a>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Locations
                                                      </a>
                                                        <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Ventes</a>
                                                        <ul class="dropdown-menu">
