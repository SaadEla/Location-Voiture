						...
						<div class="row">
							<div class="col-lg-6">
								<ul class="ht-breadcrumb pull-left">
									...
									<li class="home-act"><a href="#">Véhicules</a></li>
									<li class="active">en Stock</li>
								</ul>
							</div>
						</div>
					</div>
	  ...
	  ?>
											...
											<div class="col-sm-6 col-md-7 col-lg-8 static-position">
												<div class="product-caption">
													...
													<a href="car_detailadmin.php?idvehi=<?php echo $key['idVehicule'];?>" class="ht-btn ht-btn-default">Vérifier</a>
