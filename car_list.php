				...
				<div class="wrap-body-inner">
					...
					<div class="hidden-xs">
						<div class="row">
							...
							<div class="col-lg-6">
								<a href="#" class="ht-btn ht-btn-default pull-right m-t-lg-0"><i class="fa fa-upload"></i>Upload your Vehicle</a>
							</div>
						</div>
					</div>
					<!-- Car list -->
							...
							<div class="col-sm-5 col-md-4 col-lg-3">
								...
								<div class="search-option m-b-lg-50 p-lg-20">
									<div class="select-wrapper m-b-lg-15">
										<div class="dropdown">
											<button class="dropdown-toggle form-item" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Condition
												</button>
									...
									<div class="select-wrapper m-b-lg-15">
										<div class="dropdown">
											<button class="dropdown-toggle form-item" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Body
												</button>
									...
									<div class="select-wrapper m-b-lg-15">
										<div class="dropdown">
											<button class="dropdown-toggle form-item" type="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Make
												</button>
									...
									<div class="select-wrapper m-b-lg-15">
										<div class="dropdown">
											<button class="dropdown-toggle form-item" type="button" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Model
												</button>
									...
									<div class="select-wrapper m-b-lg-15">
										<div class="dropdown">
											<button class="dropdown-toggle form-item" type="button" id="dropdownMenu5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Year
												</button>
									...
									<div class="select-wrapper m-b-lg-15">
										<div class="dropdown">
											<button class="dropdown-toggle form-item" type="button" id="dropdownMenu6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Tranmission
												</button>
									...
									<button type="button" class="ht-btn ht-btn-default m-t-lg-30"><i class="fa fa-search"></i>Search Now</button>
								</div>
								<div class="clearfix"></div>
								<!-- Banner -->
							...
							<div class="col-sm-7 col-md-8 col-lg-9">
								...
								<div class="product product-list car">
									<div class="heading heading-2 m-b-lg-0">
										<h3 class="p-l-lg-20">Used Cars</h3>
									</div>
									<div class="product-filter p-t-xs-20 p-l-xs-20">
										<div class="m-b-xs-10 pull-left">
											<a href="car_grid.html"><i class="fa fa-th"></i></a>
											<a href="car_list.html" class="active"><i class="fa fa-th-list"></i></a>
										</div>
										<div class="pull-right">
											<div class="m-b-xs-10 m-r-lg-20 pull-left">
												<label class="pull-left p-t-lg-10 m-r-lg-5"><i class="fa fa-sort-alpha-asc"></i>Filter : </label>
												<div class="select-wrapper pull-left">
													<div class="dropdown pull-left">
														<button class="dropdown-toggle form-item w-130" type="button" id="dropdownMenu7" data-toggle="dropdown" aria-haspopup="true"
														    aria-expanded="true">
																Latest
															</button>
											...
											<div class="pull-left">
												<label class="pull-left p-t-lg-10 m-r-lg-5"><i class="fa fa-sort-alpha-asc"></i>Show : </label>
												<div class="select-wrapper pull-left">
													<div class="dropdown pull-left">
														<button class="dropdown-toggle form-item w-80" type="button" id="dropdownMenu8" data-toggle="dropdown" aria-haspopup="true"
														    aria-expanded="true">
																6
															</button>
									...
									<div class="product-item hover-img">
										<div class="row">
											<div class="col-sm-12 col-md-5 col-lg-5">
												<a href="#" class="product-img"><img src="images/b-img-3.jpg" alt="image"></a>
											</div>
									...
									<div class="product-item hover-img">
										<div class="row">
											<div class="col-sm-12 col-md-6 col-lg-5">
												<a href="#" class="product-img"><img src="images/b-img-1.jpg" alt="image"></a>
											</div>
									...
									<div class="product-item hover-img">
										<div class="row">
											<div class="col-sm-12 col-md-6 col-lg-5">
												<a href="#" class="product-img"><img src="images/b-img-2.jpg" alt="image"></a>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-7">
												<div class="product-caption">
													<h4 class="product-name">
									...
									<div class="product-item hover-img">
										<div class="row">
											<div class="col-sm-12 col-md-6 col-lg-5">
												<a href="#" class="product-img"><img src="images/b-img-4.jpg" alt="image"></a>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-7">
												<div class="product-caption">
													<h4 class="product-name">
									...
									<div class="product-item hover-img">
										<div class="row">
											<div class="col-sm-12 col-md-6 col-lg-5 ">
												<a href="#" class="product-img"><img src="images/b-img-10.jpg" alt="image"></a>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-7">
												<div class="product-caption">
													<h4 class="product-name">
													...
													<b class="product-price color-red">$201,000</b>
													<p class="product-txt m-t-lg-10">Nunc facilisis sagittis ullamcorper. Proin lectus ipsum</p>
													<ul class="static-caption m-t-lg-20">
														<li><i class="fa fa-clock-o"></i>2017</li>
														<li><i class="fa fa-tachometer"></i>Automatic</li>
														<li><i class="fa fa-road"></i>13,000</li>
									...
									<div class="product-item hover-img">
										<div class="row">
											<div class="col-sm-12 col-md-6 col-lg-5">
												<a href="#" class="product-img"><img src="images/b-img-11.jpg" alt="image"></a>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-7">
												<div class="product-caption">
													<h4 class="product-name">
