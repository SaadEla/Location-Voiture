                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="banner-item banner-2x no-bg color-inher">
                            <h2 class="f-weight-300">Plus de <strong>200 </strong>Vehicule Disponible dans notre Agence</h2>
                            <p>10 ans d'experience dans le domaine de location de Voiture, Moto, Grand Bus avec Chauffeur</p>
                            <a href="#" class="ht-btn ht-btn-default ht-btn-2x m-t-lg-35">Voir tous nos Véhicules</a>
                        </div>
                    </div>
                </div>
            </div>
