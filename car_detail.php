				...
				<div class="wrap-body-inner">
					...
					<div class="hidden-xs">
						<div class="row">
							...
							<div class="col-lg-6">
								<a href="effectuerreservation.php?idvehil=<?php echo $idvehi; ?>&prixparj=<?php echo $m; ?>" class="ht-btn ht-btn-default pull-right m-t-lg-0"><i class="fa fa-upload"></i>Effectuer la réservation</a>
							</div>
						</div>
					</div>
					<!-- Car detail -->
									...
									<div class="product-item hover-img">
										...
										<div class="product-caption">
											<h4 class="product-name">
												<a href="#">HYUNDAI ELANTRA 2017 Nouveau Modele <b></b></a><span class="f-18"> 500,00DH</span>
											</h4>
										</div>
