...
<body class="bg-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <ul class="pull-right">
								...
								<li><a href="index.php" class="icon-1"><i class="fa fa-user"></i><span>Déconnexion</span></a></li>
                                        ...
                                        <div class="container1-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li >
                                                        <a href="affichvehiculeadmin.php"  role="button">Véhicules
                                                      </a>
                                                      <!--  <ul class="dropdown-menu">
                                                    ...
                                                    <li >
                                                        <a href="affichreservationall.php"  role="button" >Réservations</a>
                                                      <!--  <ul class="dropdown-menu">
	...
	<h2 style="color: #448aff;text-align: center;"> Affichage des Clients </h2>
...
foreach ($var as $key){
	...
	.$m."</td><td>".$p."</td><td>".$g."</td><td>".$k."</td>";
	?>
	<td>
             <a class="btn btn-danger edit" href="affichfreservation.php?idclient=<?php echo $key['iduser'];?>" aria-label="Operations">
